...
<html>
    <head>
        ...
        <title>Tu pedido ha sido procesado exitosamente</title>
    <style type="text/css">
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Tu Pedido en MiCursoDigital ha sido actualizado</h1>
                                                                <h3 class="h3">Hola {{ $order->recipient_name }} {{ $order->email }} </h3>
                                                                A continuación te relacionamos la información actualizada de tu orden:
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                                <h5>Si encuentras algún dato incorrecto, por favor comunícate urgentemente a la siguiente dirección de correo electrónico para evitar inconvenientes en la entrega de tu pedido: <a href="mailto:ventas@micursodigital.com">ventas@micursodigital.com</a></h5>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                              ...
                                                              <tr>
                                                                  <td valign="middle" class="templateButtonContent">
                                                                      <div mc:edit="std_content02">
                                                                          <a href="{{ route('compras.show', $order->shoppingCartID()) }}" target="_blank">Ver más información de mi pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
                                                                <em>Copyright &copy; {{date('Y')}} MiCursoDigital, All rights reserved.</em>
                                                                <br />
                                                                <strong>Nuestra dirección de correo es:</strong>
                                                                <br />
                                                                <a href="mailto:ventas@micursodigital.com">ventas@micursodigital.com</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
